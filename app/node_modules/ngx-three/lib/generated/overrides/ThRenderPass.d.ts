...
export declare class ThRenderPass<T extends RenderPass = RenderPass, TARGS extends any[] = [scene: Scene, camera: Camera, overrideMaterial?: Material, clearColor?: Color, clearAlpha?: number]> extends ThRenderPassGen<T, TARGS> implements AfterContentChecked {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<ThRenderPass<any, any>, "th-renderPass", never, {}, {}, never, never>;
}
