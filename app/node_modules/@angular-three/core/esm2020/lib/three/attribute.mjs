...
NgtAttribute.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "13.0.3", ngImport: i0, type: NgtAttribute, deps: [{ token: i0.NgZone }, { token: i1.NgtGeometry, optional: true }], target: i0.ɵɵFactoryTarget.Directive });
