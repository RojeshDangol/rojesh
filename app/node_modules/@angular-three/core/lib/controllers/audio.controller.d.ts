...
export declare class NgtAudioController extends Controller {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<NgtAudioController, "    ngt-audio,    ngt-positional-audio,  ", ["ngtAudioController"], { "autoplay": "autoplay"; "buffer": "buffer"; "detune": "detune"; "loop": "loop"; "loopStart": "loopStart"; "loopEnd": "loopEnd"; "offset": "offset"; "duration": "duration"; "playbackRate": "playbackRate"; "isPlaying": "isPlaying"; "hasPlaybackControl": "hasPlaybackControl"; "sourceType": "sourceType"; "source": "source"; "filters": "filters"; "audioController": "audioController"; }, {}, never>;
}
