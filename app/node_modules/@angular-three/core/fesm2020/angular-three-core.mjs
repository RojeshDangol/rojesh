...
import { Directive, Injectable, InjectionToken, inject, ElementRef, NgZone, Inject, EventEmitter, Component, ChangeDetectionStrategy, Self, HostBinding, Input, Output, ViewChild, Optional, ChangeDetectorRef, NgModule, SkipSelf, Pipe, ViewContainerRef, TemplateRef, ContentChild } from '@angular/core';
import * as THREE from 'three';
import { MathUtils } from 'three';
import { __classPrivateFieldGet, __classPrivateFieldSet } from 'tslib';
import { requestAnimationFrame, clearTimeout, setTimeout } from '@rx-angular/cdk/zone-less';
import * as i1 from 'rxjs';
import { noop, catchError, EMPTY, tap, Subject, Observable, pipe, debounceTime, takeUntil, fromEvent, share, ReplaySubject, map, take, forkJoin, of, defer, throwError } from 'rxjs';
